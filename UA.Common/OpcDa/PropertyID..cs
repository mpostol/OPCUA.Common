...
namespace UAOOI.OPCUA.Common.OpcDa
{
    ...
    public struct PropertyID : ISerializable
    {
        ...
        #endregion Object Member Overrides
    ...
    public class Property
    {
        ...
        /// <remarks/>
        public static readonly PropertyID DATATYPE = new PropertyID("dataType", 1, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID VALUE = new PropertyID("value", 2, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID QUALITY = new PropertyID("quality", 3, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID TIMESTAMP = new PropertyID("timestamp", 4, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID ACCESSRIGHTS = new PropertyID("accessRights", 5, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID SCANRATE = new PropertyID("scanRate", 6, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID EUTYPE = new PropertyID("euType", 7, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID EUINFO = new PropertyID("euInfo", 8, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID ENGINEERINGUINTS = new PropertyID("engineeringUnits", 100, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID DESCRIPTION = new PropertyID("description", 101, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID HIGHEU = new PropertyID("highEU", 102, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID LOWEU = new PropertyID("lowEU", 103, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID HIGHIR = new PropertyID("highIR", 104, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID LOWIR = new PropertyID("lowIR", 105, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID CLOSELABEL = new PropertyID("closeLabel", 106, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID OPENLABEL = new PropertyID("openLabel", 107, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID TIMEZONE = new PropertyID("timeZone", 108, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID CONDITION_STATUS = new PropertyID("conditionStatus", 300, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID ALARM_QUICK_HELP = new PropertyID("alarmQuickHelp", 301, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID ALARM_AREA_LIST = new PropertyID("alarmAreaList", 302, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID PRIMARY_ALARM_AREA = new PropertyID("primaryAlarmArea", 303, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID CONDITION_LOGIC = new PropertyID("conditionLogic", 304, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID LIMIT_EXCEEDED = new PropertyID("limitExceeded", 305, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID DEADBAND = new PropertyID("deadband", 306, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID HIHI_LIMIT = new PropertyID("hihiLimit", 307, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID HI_LIMIT = new PropertyID("hiLimit", 308, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID LO_LIMIT = new PropertyID("loLimit", 309, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID LOLO_LIMIT = new PropertyID("loloLimit", 310, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID RATE_CHANGE_LIMIT = new PropertyID("rangeOfChangeLimit", 311, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID DEVIATION_LIMIT = new PropertyID("deviationLimit", 312, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID SOUNDFILE = new PropertyID("soundFile", 313, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        #endregion Data Access Properties

        #region Complex Data Properties
        public static readonly PropertyID TYPE_SYSTEM_ID = new PropertyID("typeSystemID", 600, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID DICTIONARY_ID = new PropertyID("dictionaryID", 601, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID TYPE_ID = new PropertyID("typeID", 602, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID DICTIONARY = new PropertyID("dictionary", 603, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID TYPE_DESCRIPTION = new PropertyID("typeDescription", 604, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID CONSISTENCY_WINDOW = new PropertyID("consistencyWindow", 605, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID WRITE_BEHAVIOR = new PropertyID("writeBehavior", 606, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID UNCONVERTED_ITEM_ID = new PropertyID("unconvertedItemID", 607, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID UNFILTERED_ITEM_ID = new PropertyID("unfilteredItemID", 608, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID DATA_FILTER_VALUE = new PropertyID("dataFilterValue", 609, Namespace.OPC_DATA_ACCESS);
        #endregion Complex Data Properties

        #region XML Data Access Properties
        /// <remarks/>
        public static readonly PropertyID MINIMUM_VALUE = new PropertyID("minimumValue", 109, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID MAXIMUM_VALUE = new PropertyID("maximumValue", 110, Namespace.OPC_DATA_ACCESS);
        /// <remarks/>
        public static readonly PropertyID VALUE_PRECISION = new PropertyID("valuePrecision", 111, Namespace.OPC_DATA_ACCESS);
        #endregion XML Data Access Properties
    }
